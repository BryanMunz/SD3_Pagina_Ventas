...
<body>
	...
	<table style="margin: 0 auto; cellpadding: 0; cellspacing: 0; background-color: #ffffff; text-align: center;">
		<tbody>
			<tr>
				<td>
			...
			<tr>
				<td>
					...
					<p><strong>Verifica tu cuenta con el siguiente código de confirmación</strong></p>
					<h2><?= $data['codigo']; ?></h2>
					...
					<a href="<?= BASE_URL !== '' ? rtrim(BASE_URL, '/') . '/registro' : 'https://www.sutec3d.com/registro'; ?>" target="_blank" class="x_button_link x_link_blue">Verifica tu cuenta</a>
