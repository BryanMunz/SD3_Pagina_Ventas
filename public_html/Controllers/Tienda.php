...
class Tienda extends Controllers
{
	...
	public function procesarVenta()
	{
		if ($_POST) {
			...
			if (!empty($_SESSION['arrCarrito'])) {
				...
				$monto =  $subtotal + ($subtotal * IVA) + COSTOENVIO;
				//Pago contra entrega
	...
	public function procesarVentaMercadoPago()
	{
		if ($_POST) {
			$idtransaccionpaypal = intval($_POST['idtransaccion']);
			$datospaypal = NULL;
			$personaid = $_SESSION['idUser'];
			$monto = 0;
			$tipopagoid = intval($_POST['inttipopago']);
	...
	public function procesarVentaPendiente()
	{
		if ($_POST) {
			$idtransaccionpaypal = intval($_POST['idtransaccion']);
			$datospaypal = NULL;
