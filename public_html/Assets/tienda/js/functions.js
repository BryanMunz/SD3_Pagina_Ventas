...
if(document.querySelector("#wallet_containerr")){
	let btnPago = document.querySelector("#wallet_containerr");
...
// document.querySelector('[href="' + base_url() + '/tienda/confirmarpedido/"]').id = 'miElementoDeExito';

if(document.querySelector("#l")){
	let btnPago = document.querySelector("#l");
	btnPago.addEventListener('click',function() { 
		let dir = document.querySelector("#txtDireccion").value;
	    let ciudad = document.querySelector("#txtCiudad").value;
	    let inttipopago = document.querySelector("#listtipopago").value; 
