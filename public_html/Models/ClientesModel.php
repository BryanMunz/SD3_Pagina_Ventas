...
class ClientesModel extends Mysql
{
	...
	public function insertCliente(string $identificacion, string $nombre, string $apellido, int $telefono, string $email, string $codigo, string $confimado, string $password, int $tipoid, string $nit, string $nomFiscal, string $dirFiscal)
	{
		...
		if (empty($request)) {
			$query_insert = "INSERT INTO persona(identificacion, nombres, apellidos, telefono, email_user, password, rolid, nit, nombrefiscal, direccionfiscal,codigo,confirmado) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
			$arrData = array(
